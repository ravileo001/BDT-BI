...
import com.sci.testamigo.bi.db.TestAmigoDBManagerHelper;
import com.sci.testamigo.bi.report.FeatureDetails;
import com.sci.testamigo.bi.report.ScenarioDetails;
import com.sci.testamigo.bi.report.StepDetails;
...
public class BIRunnerSetup {
  ...
  public void BIrunnerOptions(String featureName) throws Throwable {
    ...
    try {
      ...
      if (!(featureName.contains("Signin") || featureName.contains("Sign-Out"))) {
